...
export default function Questions() {
  ...
  const MobileToggle = () => (
    <div className="lg:hidden flex justify-center space-x-4 mb-6">
      {["topics", "questions", "destinations"].map((view) => (
        <button
          key={view}
          onClick={() =>
            setMobileView(view as "topics" | "questions" | "destinations")
          }
          className={`px-4 py-2 rounded-full ${
            mobileView === view ? "bg-yellow-600 text-white" : "bg-gray-200"
          }`}
        >
