...
const Newsletter: React.FC = () => {
  const [email, setEmail] = useState<string>(""); // explicitly type string
  const [subscribed, setSubscribed] = useState<boolean>(false); // boolean state
        ...
        {subscribed ? (
          <div className="animate-fade-in">
            ...
            <p className="text-lg text-gray-600 max-w-md mx-auto">
              Thank you for subscribing! You'll receive our exclusive travel
              guides and insider tips straight to your inbox.
            </p>
            <button
          ...
          <>
            <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed">
              Get exclusive travel guides and inspiring stories delivered
              weekly.
            </p>
            <form
