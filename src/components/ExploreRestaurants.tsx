  ...
  const restaurantList: Restaurant[] = [
    {
      ...
      city: "Lahore",
      img: haveli,
      duration: "Open 5pm - 11pm",
      rating: "4.6 (1.1k reviews)",
      price: "1500 Avg",
    },
    {
      name: "Chalet Restaurant",
      city: "Istanbul",
      img: chalet,
      duration: "Open 1pm - 1am",
    ...
    },
    {
      ...
      city: "Islamabad",
      img: isbdrest,
      duration: "Open 11am - 11pm",
      rating: "4.4 (780 reviews)",
      price: "2000 Avg",
    },
    {
      name: "Zeytin Restaurant",
      city: "Antalya",
      img: zeytin,
      duration: "Open 10am - 10pm",
