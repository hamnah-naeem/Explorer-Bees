...
import { episodes, type Podcast } from "../dummy-data/podcast-data";
...
const PodcastDetailPage: React.FC<PodcastDetailPageProps> = ({
  ...
  const [visibleEpisodes, setVisibleEpisodes] = useState<number>(6);
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      <div className="container mx-auto px-6 py-8">
        ...
        {/* Podcast Header */}
        <div className="relative flex flex-col md:flex-row gap-8 mb-10 rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="relative flex flex-col md:flex-row gap-8 p-8 w-full">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-700 mb-8">
                ...
                <span className="w-1 h-1 bg-gray-500 rounded-full"></span>
                <span>
                  by <span className="font-medium">{podcast.host}</span>
                </span>
              </div>
            ...
            {[1, 2, 3].map((i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Interesting content you might enjoy
                </p>
