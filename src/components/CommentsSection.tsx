  ...
  const [comments, setComments] = useState<Comment[]>([
    {
      ...
      name: "Harlie",
      comment:
        "We tried the most spectacular view, unfortunately it was very sad in the rainy from 7-20/3 pm due to we are overthinking and our picnic",
      rating: 5,
    ...
    },
    {
      ...
      name: "Smith",
      comment:
        "Stunning views of Queenstown. Very photogenic and a so main. Definitely gonna come back one visit.",
      rating: 5,
      timeAgo: "1 hour ago",
      avatar: card2,
    },
